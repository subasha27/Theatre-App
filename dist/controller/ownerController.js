        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (dateCount == 0 || dateCount < theatreData.totalScreen) {
                    const existingData = yield modelMethods_1.default.findOne(theatreModel_1.Movies, { "screenName": screenData.screenName });
                    if (existingData) {
                    ...
                    const subCount = yield modelMethods_1.default.count(theatreModel_1.Movies, { "date": new Date(screenData.date) });
                    if (theatreData)
                        screenCount = theatreData.totalScreen;
                    if (screenCount) {
